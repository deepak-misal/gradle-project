<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.techlab.model.AccountHolder" %>
    <%@ page import="com.techlab.repository.BankRepository" %>
<!DOCTYPE html>
<html>
<head>
	...
	<div nav class="navbar-collapse collapse">
		<ul class="nav navbar-nav">
  		...
  		<ul class="nav navbar-nav navbar-right">
    		...
    		<li><a href="transaction" style="color:white;"><i class="glyphicon glyphicon-transfer"></i> Transaction</a></li>
    		<li><a href="register" style="color:white;"><i class="glyphicon glyphicon-off"></i> Register</a></li>
		    <%
		    	...
		    	if(name1!=null){
		    		...
		    		out.println("<li><a href='login' style='color:white;'><i class='glyphicon glyphicon-log-in'></i> Log In</a></li>");
